...
**Chat App** is a Ruby on Rails blog application that allows users to send messages to each other that can only be read once.

Submitted by: **Nguyen Van Ven**

Time spent: **15** hours

URL: **https://mighty-citadel-18520.herokuapp.com**
